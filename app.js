...
Drink.prototype.render = function () {
    ...
    if(typeof this.ingredients === "string") {
        ...
        for (let i = 0; i < this.ingredientsArr.length; i++) {
            let list = document.createElement("li");
            list.textContent = this.ingredientsArr[i];
...
let latte = new Drink("Latte", ["milk", "ice", "sugar"], "./assets/latte.png", false, true, 1);
